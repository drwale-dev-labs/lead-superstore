  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      <div className="text-center">
        {step === "email" ? (
          <Mail className="mx-auto h-10 w-10 text-orange-700" />
        ) : (
          <KeyRound className="mx-auto h-10 w-10 text-orange-700" />
        )}
      ...
      {step === "email" ? (
        ...
        >
          <input
            ...
            className="w-full rounded-md border border-stone-300 bg-white px-3 py-2.5 text-sm focus:border-orange-700 focus:outline-none"
          />
          {requestMut.isError && (
        ...
        >
          <input
            ...
            className="w-full rounded-md border border-stone-300 bg-white px-3 py-2.5 text-center text-lg tracking-[0.5em] focus:border-orange-700 focus:outline-none"
          />
          {verifyMut.isError && (
